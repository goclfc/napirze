...
const Video = (props: Props) => {
  return (
    ...
    <div className="absolute  text-white font-smooch-bold w-full text-center font-bold text-lg sm:text-3xl lg:text-[40px] xl:[50px] 2xl:text-[76px] bottom-20 sm:bottom-32 lg:bottom-44 xl:bottom-64 2xl:bottom-80"> Reconceptualising the human-river relationship and culture</div>
